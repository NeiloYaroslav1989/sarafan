package com.neiloyv.sarafan.controller;

import com.neiloyv.sarafan.exceptions.NotFoundException;
...
public class MessageController {
    ...
    private List<Map<String, String>> messages = new ArrayList<Map<String, String>>() {{
        ...
        add(new HashMap<String, String>() {{put("id", "3"); put("text", "second message");}});
    ...
    @GetMapping("{id}")
    public Map<String, String> getFirstMessage(@PathVariable String id) {
